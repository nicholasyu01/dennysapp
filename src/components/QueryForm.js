        ...
        if (val?.label === 'FINANCIALS') {
            setCommodityOptions(
                [
                    ...
                    {
                        id: 10, label: 'JAPANESE YEN (CME) 097741', comId: '097741', oldDate: '2006-06-13', newDate: endDate, name: "Commitment of Traders - JAPANESE YEN (CME) - Futures and Options (097741)",
